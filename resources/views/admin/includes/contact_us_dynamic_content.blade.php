...
<section class="content">
    ...
    <form action="{{route('dyanmic-content')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-3">
                    <div class="image-preview" id="banner_img_preview">
                        @if (!empty($meta_data['page_content']->content['banner_img']))
                            <img src="{{asset('public/admin/dist/img/contact_us/'.$meta_data['page_content']->content['banner_img'])}}" alt="">
                        @endif
                    </div>
                </div>
        ...
        <div class="box-wrap">
            <div class="row">
                <label class="col-sm-3 control-label">Ph No.</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="ph_no" id="ph_no" value="{{old('ph_no',$meta_data['page_content']->content['ph_no']??'')}}">
                </div>
            </div>
        </div>
        <div class="box-wrap">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="email" id="email" value="{{old('email',$meta_data['page_content']->content['email']??'')}}">
                </div>
            </div>
        </div>
        <div class="box-wrap">
            <div class="row">
                <div class="col-lg-12">
                    <input type="hidden" name="page_type" id="page_type" value="CONTACT_US">
