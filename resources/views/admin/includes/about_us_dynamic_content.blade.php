    ...
    <form action="{{route('dyanmic-content')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-sm-3">
                    <div class="image-preview" id="banner_img_preview">
                        @if (!empty($meta_data['page_content']->content['banner_img']))
                            <img src="{{asset('public/admin/dist/img/about_us/'.$meta_data['page_content']->content['banner_img'])}}" alt="">
                        @endif
                    </div>
                </div>
        ...
        <div class="box-wrap">
            <div class="row">
                ...
                <div class="col-sm-6">
                <input type="file" id="about_img" class="form-control" name="about_img" onchange="preview_image(this,'#about_img_preview')" />
                </div>
                <div class="col-sm-3">
                    <div class="image-preview" id="about_img_preview">
                        @if (!empty($meta_data['page_content']->content['about_img']))
                            <img src="{{asset('public/admin/dist/img/about_us/'.$meta_data['page_content']->content['about_img'])}}" alt="">
                        @endif
                    </div>
                </div>
                <input type="hidden" name="old_about_img" value="{{$meta_data['page_content']->content['about_img']??''}}">
            </div>
        </div>
        <div class="box-wrap">
            <div class="row">
        ...
        <div class="box-wrap">
            <div class="row">
                <div class="col-lg-12">
                    <input type="hidden" name="page_type" id="page_type" value="ABOUTUS">
