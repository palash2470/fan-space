...
<table width="560px" border="0" cellspacing="0" cellpadding="0" style="background:#E8EEFF; font-size:14px;color:#333;font-family:Arial, Helvetica, sans-serif; padding:15px; margin:15px auto; border:#eee 1px solid;">
  <tr>
    <td colspan="2" style="padding:20px 15px 40px;"><center><img src="{{asset('public/uploads/settings/settings_website_logo/f32ed34d-5e31-494f-b20a-65de6c6c981f.png')}}" width="277" alt=""></center></td>
  </tr>
   <tr>
	<td>
  ...
  <tr>
    <td style="padding:0 15px;" align="center">
      <table width="560px" style=" margin:20px 0 20px; border-top: 1px solid #ddd; padding:20px 0 0;">
            <tr>
                <td colspan="2"  width="" style="padding:0; font-size:12px; color:#666; text-align:center;  opacity: 0.7;">© {{date('Y')}} Aqualeaf IT Solutions Pvt Ltd.</td>
            </tr>
        </table>
    </td>
  </tr>
