    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="ticket-wrap">
                    <div class="ticket-wrap-box">
                            @if ($meta_data['ticket_dtl']->status==0)
                                <h3 class="w-100 d-flex justify-content-between">Ticket details <span class="opn-cls-btn"><button type="button" class="btn btn-xs btn-danger">closed</button></span></h3>
                            @else
                                <h3 class="w-100 d-flex justify-content-between">Ticket details <span class="opn-cls-btn"><button type="button" class="btn btn-xs btn-success">open</button></span></h3>
                            @endif
            ...
            <div class="col-lg-7 col-md-7 col-sm-6 col-12">
                <div class="ticket-chat mt-sm-0 mt-4">
                    @if (\Auth::user()->role==1)
