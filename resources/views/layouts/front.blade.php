...
if (isset($user_data['id'])) {
    $total_notifications = Notification::where('user_id', $user_data['id'])
        ->where('seen', '0')
        ->count();
}
$total_cart_items = 0;
...
<body>
        ...
        <div class="container-fluid p-h-40">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="search d-flex align-items-center">
                    <div class="srcInner">
                        <div class="mobSrcBox">
                            <a href="javascript:;" class="searchMob"><i class="fas fa-search"></i></a>
                        </div>
                        <div class="searchInner relative">
                            <input type="text" name="s" id="" class="modelSearch"
                                value="{{ $meta_data['search_params']['s'] ?? '' }}" />
                            <button type="button" class="modelSearchBtn search_submit"><i
                ...
                <div class="logReg d-flex justify-content-center">
                    <ul class="d-flex">
                        ...
                        <?php if(in_array($user_data['role'], [2, 3])) {
                                ...
                                ?>
                        <li><a href="javascript:;" class="balanceBtn"><i
                                    class="fas fa-coins"></i><span>{{ $wallet_coins . ' ' . ($wallet_coins == 1 ? 'Coin' : 'Coins') }}</span></a>
                        </li>
                        <li><a href="{{ url('dashboard/notification') }}" class="greyBtn notifBtn"><i
                                    class="ti-bell"></i>
                        ...
                        <li><a href="{{ url('cart') }}" class="greyBtn cartBtn"><i
                                    class="m-r-0 fas fa-shopping-cart"></i>
                        ...
                        <?php } ?>
                        <li><a href="{{ $user_data['dashboard_url'] }}" class="blueBtn"><i
                                    class="fas fa-user"></i><span>Account</span></a></li>
                        <li><a href="{{ $user_data['logout_url'] }}" class="greyBtn"
                                onclick="return confirm('Are you sure you want to logout?');"><i
                                    class="m-r-0 fas fa-power-off"></i><!-- <span>Logout</span> --></a></li>
                        <?php } ?>
                        ...
                        <li><a href="{{ $user_data['logout_url'] }}" class="greyBtn"
                                onclick="return confirm('Are you sure you want to logout?');"><i
                                    class="m-r-0 fas fa-power-off"></i><span>Log Out</span></a></li>
                        <?php } ?>
                        <?php } else { ?>
                        <li><a href="javascript:;" class="loginBtn"><i class="fas fa-user"></i><span>LOGIN</span></a>
                        </li>
                        <li><a href="javascript:;" class="register"><i
                                    class="fas fa-pencil-alt"></i><span>Register</span></a></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
    ...
    <footer class="mainFooter">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-auto col-md-auto col-sm-12 col-12 mbOrder-2">
                    <div class="address">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mbInner">
                        <h5>A verification code was sent via email to <strong id="toEmail"></strong>.When you receive
                            the code,Enter it below</h5>
                        <div class="otpAtra">
                            <div class="otpTop">
                                <h4>OTP</h4>
                            </div>
                ...
                <div class="modal-body">
                    <div class="mbInner">
                        ...
                        <div class="otpAtra">
                            ...
                            <div class="otpBtm d-flex">
                                <input type="text" placeholder="OTP PASSWORD" name="phone_otp_password"
                                    id="phone_otp_password" onKeyPress="return isNumber(event)">
                                <button type="button" onClick="matchPhoneOtpPassword()">OK</button>
                            </div>
                            <span id="error_phone_otp_msg" class="tryAgain"></span>
                        </div>
                        <div class="rcvSms text-center"> Didn't receive the sms <a href="javascript:;"
                                class="sendPhoneOtp">Resend</a> </div>
                    </div>
                </div>
            </div>
        </div>
  ...
  <span class="aa">dfdfdfdfdff</span> -->
    ...
    $('.searchMob').click(function(e) {
      alert("Hello! I am an alert box!!");
        ...
        $(document).on('click', '.searchMob', function() {
            $(".searchInner").toggleClass('active');
        })
    </script>
    <script type="text/javascript">
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=<?php echo $meta_data['global_settings']['settings_google_map_api_key']; ?>&callback=initGoogleAutocomplete&libraries=places"
        async></script>
    <script type="text/javascript">
