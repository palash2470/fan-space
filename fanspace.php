...
if(isset($_POST['uname'])) {
	if($_POST['uname'] == 'fanspace' && $_POST['password'] == 'fanAntSpaceLeon') {
		$_SESSION['fanspace'] = '1';
		header('Location: http://localhost/onlyfans');
		exit;
	}
}
?>
...
<head>
    ...
    <style type="text/css">
    	.site-header-large-bg span {
			    ...
			    height: 100vh;
			    background: #8179f2;
			    background: linear-gradient(to bottom, #0aaef0 0, #8fdaef 100%);
...
<body class="is-boxed has-animations">
            ...
            <div class="container">
                ...
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
                            <a href="#">
                            	<img src="public/landing/dist/images/logo.png" alt="" style="max-height: 60px;">
                    ...
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <div class="container-sm">
                                <h1 class="hero-title h2-mobile mt-0 is-revealing">Login</h1>
                                ...
                                <form method="post">
                                  ...
                                  <div class="control">
                                      <input class="button button-primary button-block button-shadow" type="submit" value="Enter site" />
                                  </div>
																</form>
                                <!-- <form method="post">
    ...
    <script src="public/landing/dist/js/main.min.js"></script>
</body>
</html>
