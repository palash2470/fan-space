...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'first_name', 'last_name', 'username', 'email', 'phone', 'display_name', 'dob', 'role', 'social_login', 'password', 'affiliate_user_id', 'remember_token', 'password_reset_token', 'status', 'last_activity'
    ];
